...
class AddGuest:
    ...
    def verify(self, lname, fname):
        """
        Se cauta last name si first name in listele de guests
        Daca se gasesc, mesaj
        Daca nu se gasesc, se adauga in lista si mesaj
...
class ChangeName:
    ...
    def verify(self, lname, fname):
        """
        Se cauta lname si fname in listele de guest
        Daca nu se gasesc, mesaj
        Daca se gasesc, entry nou new last name si se creeaza butonul de change
        :param lname: entry_lname
        :param fname: entry_fname
        """
        self.lname = lname
    ...
    def change_entry(self, lastname):
        """
        Se schimba last name in fisierele guests si bookings si mesaj
...
class DeleteGuest:
    ...
    def verify(self, lname, fname):
        """
        Se cauta lname si fname in lista cu guests, daca se gaseste se sterge si se cauta si in lista de bookings
        Daca se gaseste se sterge si din bookings
        Daca nu se gaseste un guest, mesaj
        :param lname: entry_lname
        :param fname: entry_fname
        """
        found = False
