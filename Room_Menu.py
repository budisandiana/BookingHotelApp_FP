...
class AddRoom:
    ...
    def verify(self, number):
        """
        Se cauta number in lista cu numere, dc nu se gaseste se formeaza entry_*proprietati room*
        Dc se gaseste, mesaj
    ...
    def add_entry(self, number, capacity, price, color, seaview):
        """
        se adauga *propr. room* la liste si la fisier, mesaj
        :param number: entry_number
        :param capacity: entry_capacity
        :param price: entry_price
        :param color: entry_color
        :param seaview: entry_seaview
        """
...
class ChangePrice:
    ...
    def verify(self, number):
        """
        Se cauta number in lista cu numere
...
class DeleteRoom:
    ...
    def verify(self,number):
        """
        se cauta numarul camerei in lista cu numere, daca se gaseste, se sterge
        :param number: entry_number
        """
        found = False
        for i in range(len(self.room.lnumber)):
...
class ShowRooms:
    def __init__(self, master):
        ...
        self.backButton.place(x=545, y=265)
